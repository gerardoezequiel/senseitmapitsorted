...
---
# Analysis - Flood Risk Assessment (ML) (Jan)

---
# Analysis - Vulnerability Assessment (Land Use/Expansion) (Soki)
...
2. Calculate the required spread (km^2) of urban area, using the population prediction as the independent variable
3. (if possible) Calculate the predicted spread of urban area for various scenarios, including
...
| Year | Population | Built up area (km^2) |
| --- | --- | --- |
| 2000 |  |  |
| 2010 |  |  |
| 2020 |  |  |
...
## Map of predicted built-up areas

( some maps showing extent of urban area for different scenarios in different years )
